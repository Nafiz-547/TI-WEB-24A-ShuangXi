        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 lg:col-span-1 lg:sticky lg:top-6">
            ...
            <div className="mt-6 pt-6 border-t border-slate-100">
              ...
              <p className="text-2xl font-black text-[#f78232]">
                ...
                {travelPackage.destinations.map((dest, index) => {
                  ...
                  return (
                    <div key={dest.id} className="relative pl-6 md:pl-8 group">
                      <span className="absolute -left-2.75 top-1.5 bg-white border-2 border-[#f78232] text-[#f78232] w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-black group-hover:bg-[#f78232] group-hover:text-white transition-colors duration-200">
                        {index + 1}
                      </span>
                      ...
                      <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 flex flex-col md:flex-row gap-5 hover:bg-white hover:shadow-md hover:border-slate-200/60 transition-all duration-200">
                        <div className="relative h-32 md:w-1/3 min-h-30 rounded-xl overflow-hidden shrink-0">
                          <Image
                            src={
                              dest.image
                                ? dest.image
                        ...
                        <div className="md:w-2/3 flex flex-col justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1.5">
                              <span
                                className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${styles.bg}`}
                              >
