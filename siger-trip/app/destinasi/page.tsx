  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 md:px-8">
      ...
      <div className="max-w-6xl mx-auto mb-10 text-center">
        ...
        <p className="text-slate-600 mt-2">Rencana perjalanan 7 hari terbaik untuk liburan Anda.</p>
      </div>
        ...
        {destinations.map((item) => (
          <Link href="{`/destinasi/${item.id}`}" key="{item.id}" className="group">
            <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-slate-100">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-slate-800 group-hover:text-[#f78232] transition-colors">
                  {item.name}
                </h3>
